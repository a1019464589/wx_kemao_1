package org.a1019464589.weixin.controller;
...
import org.a1019464589.weixin.domain.InMessage;
import org.a1019464589.weixin.service.MessageTypeMapper;
...
@RequestMapping("/zengyang/weixin/receiver")
		...
		inMessageTemplate.execute(new RedisCallback<String>() {
			...
			public String doInRedis(RedisConnection connection) throws DataAccessException {
				try {
					...
					String channel = "zengyang_" + inMessage.getMsgType();
